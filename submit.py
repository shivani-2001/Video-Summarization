...
writer = cv2.VideoWriter('output.mp4', cv2.VideoWriter_fourcc(*'DIVX'), 25, (512, 512)) # to create a new video
        ...
        for i in np.arange(0, person_detections.shape[2]):
            ...
            if confidence > 0.5:
                ...
                if CLASSES[idx] == "person":
                    ...
                    # cv2.rectangle(frame_1, (startX, startY), (endX, endY), (0, 0, 255), 2)
        ...
        for i in np.arange(0, person_detections.shape[2]):
            ...
            if confidence > 0.5:
                ...
                if CLASSES[idx] == "person":
                    ...
                    # cv2.rectangle(frame_2, (startX, startY), (endX, endY), (0, 0, 255), 2)
